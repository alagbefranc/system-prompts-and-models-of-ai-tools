...
import { Wand2, Copy, Check, Download, Sparkles, Settings, Brain, Code, Palette, Bug, Wifi, WifiOff, AlertCircle, CheckCircle } from 'lucide-react'
...
const PromptGeneratorComponent = () => {
  ...
  const [apiStatus, setApiStatus] = useState({ online: true, hasApiKey: false, canUseRealAI: false })
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (promptType === 'comprehensive') {
        result = await promptGenerator.generateComprehensivePrompt(userIdea)
      } else {
        result = await promptGenerator.generateFocusedPrompt(userIdea, focusArea)
      }
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Powered by Claude AI to create comprehensive, tailored prompts for any idea or project.
        </p>
          ...
          >
            {loading ? (
              <>
                ...
                <span>
                  {apiStatus.canUseRealAI ? 'Generating with Claude AI...' : 'Generating Prompt...'}
                </span>
              </>
            ) : (
              <>
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="flex items-center space-x-4">
                ...
                <div className={`flex items-center space-x-1 px-2 py-1 rounded-full text-xs ${
                  ...
                  <span>{generatedPrompt.isRealAI ? '🤖 Claude AI' : '📝 Template'}</span>
                </div>

    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-800">{tool.name} Tools</h1>
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <h3 className="text-gray-800 font-semibold mb-2">Available Tools</h3>
      ...
      {loading ? (
        <div className="glass-effect rounded-xl p-6 sm:p-8 text-center">
          ...
          <div className="text-gray-500">Loading tool configuration...</div>
        </div>
      ) : (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <motion.div
            ...
            className="glass-effect rounded-xl p-4 sm:p-6"
          >
            <h3 className="text-gray-800 font-semibold mb-4 flex items-center space-x-2">
            ...
            {parsedTools?.tools ? (
              <div className="space-y-3">
                {parsedTools.tools.map((toolItem, index) => (
                  ...
                  >
                    <div className="font-medium text-gray-800 text-sm">{toolItem.name || toolItem.function?.name || `Tool ${index + 1}`}</div>
            ...
            {selectedTool ? (
              <>
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <pre className="bg-gray-50 rounded-lg p-4 text-xs sm:text-sm text-gray-800 font-mono overflow-x-auto scrollbar-thin">
              ...
              <div className="p-6 sm:p-8 text-center">
                ...
                <div className="text-gray-500">Select a tool to view its details</div>
              </div>
            )}
          </motion.div>
        </div>
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 border-b border-gray-200 gap-2">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gray-800 font-semibold">Raw Configuration</span>
          </div>
        ...
        >
          ...
          >
            ...
            <div className="flex-1">
              <div className="text-gray-800 font-medium">System Prompt</div>
              <div className="text-gray-500 text-sm">View the complete system prompt</div>
            </div>
